...
mixin _$User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, fullName: $fullName, avatarUrl: $avatarUrl, countryCode: $countryCode, city: $city, interests: $interests, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
